...
bool LoadResources() {
	...
	SMILEY_SURFACE = SDL_LoadBMP("assets/face.bmp");
	...
	SHIELD_SURFACE = SDL_LoadBMP("assets/PUShield.bmp");
	...
	SDL_SetColorKey(SHIELD_SURFACE, SDL_TRUE, RGB(255, 0, 255));
